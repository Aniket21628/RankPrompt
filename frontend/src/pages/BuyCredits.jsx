        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {subscriptionPlans.map((plan, index) => (
              <div
                key={index}
                className={`glass-effect rounded-2xl border ${plan.border} p-6 flex flex-col relative ${
              ...
              >
                ...
                <button
                  ...
                  className={`w-full bg-gradient-to-r ${plan.gradient} hover:opacity-90 text-white font-bold py-3 px-6 rounded-xl transition-all mb-6`}
                >
                  Sign up
                </button>
          ...
          <div className="glass-effect rounded-2xl border border-purple-500/30 p-8 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-2">Need flexibility instead?</h2>
          ...
          {isTopUpExpanded && (
            <div className="glass-effect rounded-2xl border border-white/10 p-8 mb-6">
              ...
              <div className="space-y-4">
                {topUpOptions.map((option, index) => (
                  <div
                    key={index}
                    className="glass-light rounded-xl p-6 flex items-center justify-between hover:bg-white/10 transition-all"
                  >
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-xl font-bold text-white">{option.credits} Credits Top-Up</h3>
                    ...
                    <div className="flex items-center space-x-6 ml-6">
                      <div className="text-right">
                        <div className="text-3xl font-black text-white">${option.price}</div>
                      </div>
                      <button
                        onClick={() => handleTopUpPurchase(option)}
                        className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-xl transition-all flex items-center space-x-2"
                      >
                        <span>Purchase</span>
          ...
          <div className="glass-effect rounded-2xl border border-green-500/30 p-8">
            <div className="flex items-start space-x-4">
              <div className="p-3 rounded-xl bg-green-500/20">
                <Gift className="w-6 h-6 text-green-400" />
              </div>
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-white mb-2">Get 50 Credits Free</h2>
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold py-3 px-6 rounded-xl transition-all inline-flex items-center space-x-2"
                >
