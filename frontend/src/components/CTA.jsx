  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 gradient-bg relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto">
        <div className="relative glass-effect rounded-3xl p-12 lg:p-16 text-center border border-white/10 overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <button className="group relative">
                ...
                <div className="relative bg-gradient-to-r from-primary-500 to-accent-500 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-primary-500/50 transition-all duration-300 flex items-center justify-center space-x-3">
                  <span>Start Free Trial</span>
                  <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                </div>
              </button>
              <button className="glass-light text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all duration-300 border border-white/20">
                Schedule Demo
              </button>
            </div>
            ...
            {/* Trust Badges */}
            <div className="pt-8 flex items-center justify-center space-x-6 text-xs text-gray-400">
